...
fun CtrlApp(
    ...
    DisposableEffect(Unit) {
        registerIntentListener { dest ->
            // FIXED: If background intercept happens during an update, force it to VERIFY to prevent bypass
    ...
    NavHost(navController = navController, startDestination = startDest) {
        ...
        composable("session_dashboard") {
            SessionDashboardScreen(
                ...
                onBack = { navController.popBackStack() },
                onUpdate = {
                    // FIXED: We DO NOT clear the session here. It stays active in the background!
                    quizPurpose = "UPDATE"
            ...
            QuizScreen(
                ...
                onPass = {
                    ...
                    when (quizPurpose) {
                        ...
                        "UPDATE" -> {
                            // FIXED: We DO NOT clear the active session here.
                            readingProgress = 0.0f
                            isReadingStarted = false

                            // Navigates to step 1 to configure new variables without clearing history
