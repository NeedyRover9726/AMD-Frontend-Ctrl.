...
fun CtrlApp(
    ...
    NavHost(navController = navController, startDestination = startDest) {
        ...
        composable("quiz") {
            ...
            // FIXED: Helper to safely unpin and programmatically dismiss the system lock screen
            ...
            QuizScreen(
                ...
                onPass = {
                    ...
                    triggerGracePeriod() // IGNORE LAG BEFORE NAVIGATING
                ...
                onFailReturn = {
                    ...
                    triggerGracePeriod() // IGNORE LAG SO IT DOESNT RE-INTERCEPT
                    navController.navigate("home") { popUpTo(0) }
                }
            )
        }
        composable("unlock") {
            UnlockScreen(
                onOpenApp = {
                    isBreakMode = true
                    breakMinutes = 5
                    sessionManager.transitionToBreak(forcedBreakMinutes = 5)
                    elapsedMinutes = 0f

                    triggerSyncBreakMode()
                    triggerGracePeriod() // IGNORE LAG
