...
async def generate_quiz(topic: str = Form(...), selected_titles: str = Form(...)):
    ...
    try:
        ...
        system_prompt = (
            ...
            "4. Return ONLY a raw JSON array. Do NOT wrap the output in markdown blocks (e.g., no ```json). \n"
            "5. Output absolutely no preamble, postamble, or conversational text. Return only the JSON matching this structure exactly:\n"
            "[\n"
            "  {\n"
            "    \"question\": \"...\",\n"
            "    \"options\": [\"A\", \"B\", \"C\", \"D\"],\n"
